...
%trim option's parameter order: left bottom right top
%\includegraphics[trim = 30mm 0mm 30mm 0mm, clip, width=0.45\textwidth]{ch03_02}
\includegraphics[trim = 0mm 80mm  0mm 80mm,width=0.95\textwidth]{ch05_02}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{lccc}
        \cline{1-3}% partial hline from column i to column j
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{lccccc}
        \cline{1-5}% partial hline from column i to column j
